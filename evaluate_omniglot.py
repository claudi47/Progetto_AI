...
def main():
    ...
    # data_train = datasets.CIFAR10(root=".", download=True, train=True, transform=train_transform)
    # data_test = datasets.CIFAR10(root=".", download=True, train=False, transform=test_transform)

    data_train = datasets.CIFAR100(root=".", download=True, train=True, transform=train_transform)
    data_test = datasets.CIFAR100(root=".", download=True, train=False, transform=test_transform)
    ...
    for total_classes in no_of_classes_schedule:
        ...
        for lr_search_runs in range(0, 5):
            ...
            classes_to_keep = np.random.choice(list(range(100)), total_classes, replace=False) #650 prima
